export const servicePages = {
  getMoreGoogleReviews: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "Google reviews influence visibility, click-through rates, and conversion. A better review profile can support map pack performance because Google has more customer signals to evaluate. It can also improve the quality of traffic because prospects arrive with more confidence in your business.",
          "Reviews also reduce friction. A customer who sees useful comments about speed, communication, pricing, cleanliness, or results has fewer unanswered questions. That makes your website, phone number, and booking form work harder. For service businesses, restaurants, clinics, agencies, and local operators, reviews are often the proof point customers check before taking action.",
        ],
      },
      {
        heading: "Benefits",
        body: [
          "The biggest benefit of a structured review growth service is consistency. Many businesses ask for reviews only when a manager remembers, after a good week, or during a slow month. A planned strategy creates momentum by aligning the request, the timing, and the location focus.",
          "A second benefit is positioning. Location-specific review growth can help your business appear more relevant in the markets you care about most. If you serve New York, London, Sydney, or several surrounding areas, your review strategy should reflect those markets naturally. That local relevance can support trust when buyers search by city, neighborhood, or service category.",
          "Finally, a professional process saves time. Your team can focus on operations while the campaign moves through a defined plan. You still provide the essential details, but the structure, pacing, and support are handled for you.",
        ],
      },
      {
    ...
    ctaTitle: "Ready to get more Google reviews?",
    ctaText:
      "Start with a plan that matches your location, review goals, and pace of growth.",
  },
  increaseGoogleReviews: {
    ...
    sections: [
      ...
      },
      {
        heading: "Why reviews matter",
        body: [
          "Reviews matter because they appear close to the point of decision. A prospect may find your company in Google Maps, scan the star rating, read recent comments, and decide whether to call in less than a minute. That small moment can decide whether paid ads, SEO, referrals, and repeat searches turn into revenue.",
          "Review quality is also important. Short, vague comments have less persuasive power than specific feedback about the customer experience. A review profile that includes realistic details can help buyers understand what it is like to work with your business. That can raise confidence and reduce the need for long explanations from your sales or support team.",
        ],
      },
      {
        heading: "Benefits",
    ...
    ctaTitle: "Increase Google reviews with a structured plan.",
    ctaText:
      "Get a location-aware campaign that supports trust, visibility, and customer confidence.",
  },
  customGoogleReviews: {
    ...
    sections: [
      ...
      {
        heading: "Benefits of personalized review strategies",
        body: [
          "The first benefit is relevance. Reviews that reflect real buying concerns can help prospects answer practical questions quickly. They want to know whether a company communicates well, arrives on time, provides good value, understands the local area, and delivers the promised outcome. A custom strategy keeps those concerns at the center.",
          "The second benefit is better local SEO support. Google reviews are one part of a larger local search picture that includes profile completeness, location pages, service content, business details, and customer engagement. When review growth is planned around priority cities, it can support the same markets your website is trying to rank for.",
          "The third benefit is conversion. More people may click from Google Maps when a profile looks active, but the bigger win is confidence. Detailed, recent reviews reduce hesitation. They help a prospect feel that other customers have already tested the business and had a good experience.",
          "Personalized campaigns also keep your internal process cleaner. Instead of sending the same review request to every customer, your team can think about the right moments, the right locations, and the right service details. That creates a stronger foundation for long-term reputation growth.",
        ],
      },
      {
  ...
  googleMyBusinessReviewService: {
    eyebrow: "Complete guide",
    title: "Google My Business Review Service",
    intro:
      "A Google My Business review service helps local companies strengthen their Google Business Profile with a structured, location-aware reputation strategy that supports trust, local SEO, and conversions.",
    sections: [
      {
      ...
      },
      {
        heading: "Benefits",
        body: [
          "The biggest benefit is stronger credibility at the point of search. Customers looking at Google Maps are usually closer to action than people casually browsing social media. If your profile looks active and trusted, you have a better chance of turning that search into a call, visit, booking, or quote request.",
          "A second benefit is review recency. Many businesses have older positive reviews but not enough fresh activity. Recent reviews show that the business is still operating well and that customers are still engaging with it. This is especially important for industries where service quality can change over time.",
          "A third benefit is location relevance. Businesses that serve New York, Los Angeles, Chicago, London, Manchester, Sydney, Melbourne, or Brisbane need review strategies that reflect how customers search in those markets. City-specific planning makes reputation growth more useful for local SEO and conversion.",
          "The fourth benefit is operational clarity. Instead of asking for reviews only when someone remembers, a structured service creates a defined workflow. The business knows what information to submit, which plan to choose, how pacing works, and where customers can go next.",
        ],
      },
      {
        heading: "Problems businesses face",
        body: [
          "Many businesses struggle with inconsistent review requests. Staff may forget to ask, customers may not receive a direct link, and happy customers may leave without sharing feedback. Over time, this creates a profile that does not reflect the real quality of the business.",
          "Another problem is generic content. Vague reviews do less to persuade buyers because they do not explain what happened, what improved, or why the customer would recommend the business. Customers want practical proof: communication, speed, cleanliness, expertise, value, local knowledge, and reliability.",
          "Businesses also face competitive pressure. A company may offer excellent service but appear weaker than a competitor with more reviews, fresher feedback, and better responses. In local search, perception can decide the first click. If the review profile looks quiet, prospects may never reach the website.",
          "A final problem is disconnected SEO. Some companies publish service pages and city pages but do not connect them with reputation growth. The website says the business is trusted, but the Google profile does not support that claim strongly enough. A review service helps close the gap.",
        ],
      },
      {
        heading: "Solutions",
      ...
      },
      {
        heading: "FAQ",
        body: [
          "Businesses usually want to know whether review growth is safe, whether it can be location-based, how long it takes, and whether it can be customized. Those questions are answered below with the same practical focus used across the service.",
          "The short version is that the best campaigns are gradual, specific, and tied to real business details. That is what makes review growth more credible for customers and more useful for local SEO.",
        ],
      },
    ],
    ctaTitle: "Start a Google My Business review campaign.",
    ctaText:
      "Improve your review profile with a structured plan built around local SEO, customer trust, and conversion.",
  },
  googleReviewService: {
    ...
    sections: [
      ...
      },
      {
        heading: "Why reviews matter",
        body: [
          "Reviews can influence both discovery and conversion. Searchers often filter by rating, compare review counts, and read recent feedback before deciding which business deserves attention. In markets where many providers look similar, review depth can become the deciding factor.",
          "They also create customer language for your brand. Review themes often reveal what people value most, such as fast response times, friendly communication, local knowledge, or dependable results. That language can support website copy, ads, sales scripts, and future service improvements.",
        ],
      },
      {
        heading: "Benefits",
        body: [
          "The first benefit is a stronger trust signal. A profile with more recent and realistic reviews can make your business feel more established. This matters especially for high-intent searches where people are ready to book but still want proof.",
          "The second benefit is location relevance. A review service that understands city targeting can support pages for New York, Los Angeles, London, Sydney, and other markets. Those internal links help users move between service information and local proof points.",
          "The third benefit is operational simplicity. Owners and marketing teams do not always have time to build review systems from scratch. A service with defined pricing, a start-order page, and WhatsApp support makes the next step easier for busy teams.",
        ],
      },
      {
        heading: "How service works",
